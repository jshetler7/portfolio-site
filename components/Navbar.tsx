...
const Navbar = () => {
    ...
    return(
        <div className="grid-cols-4 flex pb-5 w-auto md:w-full justify-between ml-2 mr-2 md:m-0 md:justify-center md:gap-x-10 pt-5" id="navbar">
            <Link href={'/'}>
                <a className="flex text-2xl ml-2 md:m-0 dark:text-white hover:font-semibold hover:underline hover:underline-offset-8 hover:decoration-blue-300">
                    About
                </a>
            </Link>
            <Link href={'/portfolio'}>
                <a className="flex text-2xl dark:text-white hover:font-semibold hover:underline hover:underline-offset-8 hover:decoration-blue-300">
                    Portfolio
                    </a>
            </Link>
            <Link href={'/resume'}>
                <a className="flex text-2xl mr-2 md:m-0 dark:text-white hover:font-semibold hover:underline hover:underline-offset-8 hover:decoration-blue-300">
                    Resume
                    </a>
            </Link>
